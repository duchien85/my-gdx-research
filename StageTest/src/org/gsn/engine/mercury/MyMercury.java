...
public class MyMercury {
	...
	private class MyThread implements Runnable {
		public void run() {
			...
			try {
				...
				Debug.trace("Canot connect");
				ex.printStackTrace();
			}
			Debug.trace("Canot connect2"+ listener.toString());
			try {
	...
	public static void main1(String[] args) {
		...
		m = new MyMercury("localhost", 443, new IMercuryListener() {

			@Override
			public void onConnected() {
				// TODO Auto-generated method stub
				System.out.println("connect");
				String s = "{\"params\":{\"username\":\"1\"},\"_cmd\":\"login\",\"ext\":\"caro\"}";
				m.send(s);
			}
