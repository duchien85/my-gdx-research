...
public class ImageFactory {
	...
	public static void saveBitmapToFileAsync(final String link, final int width, final int height, final int quality, final String localPath, final IImageFactoryListener listener) {
		Thread t = new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					File fileOut = new File(Environment.getExternalStorageDirectory() + localPath);
